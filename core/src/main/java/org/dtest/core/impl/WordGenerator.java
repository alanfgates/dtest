// The following code is taken verbatim (except for the package name) from
// https://github.com/maximeroussy/invitrode/blob/master/src/main/java/com/maximeroussy/invitrode/WordGenerator.java
// where it is available under the MIT license.  It copy/pasted it rather than included it because it is not available
// in maven central.
